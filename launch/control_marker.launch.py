...
def generate_launch_description():
    ...
    control_marker = launch_ros.actions.Node(package='myCobotROS',
                                  executable='control_marker',
                                  output='both')
    ...
    return launch.LaunchDescription([robot_state_publisher, joint_state_publisher_gui, control_marker, rviz])