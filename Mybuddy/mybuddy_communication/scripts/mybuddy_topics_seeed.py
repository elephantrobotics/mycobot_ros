...
class MybuddyTopics(object):
    def __init__(self):
        ...
        self.mb = MyPalletizer(port,baud)
    ...
    def pub_real_angles(self):
        """Publish real angle"""
        """发布真实角度"""
        pub = rospy.Publisher("Mybuddy/angles_real", MybuddyAngles, queue_size=15)
        ma = MybuddyAngles()
    ...
    def pub_real_coords(self):
        ...
        """发布真实坐标"""
        pub = rospy.Publisher("Mybuddy/coords_real", MybuddyCoords, queue_size=15)
        ma = MybuddyCoords()
