...
mc.send_coords([169.2, -96.4, 198.0, -173.06, 50.9, 159.3],30,0) # above the green bucket
time.sleep(4)

# mc.send_coords([71.7, 117.2, 218.6, 151.82, 11.3, 156.74],30,0) # above the blue bucket
# time.sleep(4)
